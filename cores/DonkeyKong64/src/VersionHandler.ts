...
export namespace VersionHandler {
    export function load_jp_1_0() {
        ...
        global.ModLoader[API.AddressType.TS_TOTAL_BASE] = 0x7fcdc0;
        ...
        global.ModLoader[API.AddressType.ER_TEMP_FLAGS_BASE] = 0x7fe220;
    }
    ...
    export function load_pal_1_0() {
        ...
        global.ModLoader[API.AddressType.TS_TOTAL_BASE] = 0x7fc870;
        ...
        global.ModLoader[API.AddressType.ER_TEMP_FLAGS_BASE] = 0x7fdcd0;
    }
    ...
    export function load_usa_1_0() {
        ...
        global.ModLoader[API.AddressType.TS_TOTAL_BASE] = 0x7fc930;
        ...
        global.ModLoader[API.AddressType.ER_TEMP_FLAGS_BASE] = 0x7fdd90;
    }
}
