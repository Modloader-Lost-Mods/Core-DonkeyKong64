...
export class TempFlags extends API.BufferObj implements API.IBuffered {
    constructor(emu: IMemory) {
        super(emu, global.ModLoader[API.AddressType.ER_TEMP_FLAGS_BASE], 0x10);
    }
}

export class TnSTotals extends API.BaseObj implements API.IBanana {
    private base_addr: number = global.ModLoader[API.AddressType.TS_TOTAL_BASE];
    private jungle_japes_addr: number = this.base_addr + 0x00;
    private angry_aztec_addr: number = this.base_addr + 0x02;
    private frantic_factory_addr: number = this.base_addr + 0x04;
    private gloomy_galleon_addr: number = this.base_addr + 0x06;
    private fungi_forest_addr: number = this.base_addr + 0x08;
    private crystal_caves_addr: number = this.base_addr + 0x0a;
    private creepy_castle_addr: number = this.base_addr + 0x0c;
    private dk_isles_addr: number = this.base_addr + 0x0e;
    private hideout_helm_addr: number = this.base_addr + 0x10;
    private unknown_1_addr: number = this.base_addr + 0x12;
    private unknown_2_addr: number = this.base_addr + 0x14;
    private unknown_3_addr: number = this.base_addr + 0x16;
    private unknown_4_addr: number = this.base_addr + 0x18;
    private null_addr: number = this.base_addr + 0x1a;
...
export class Banana extends API.BaseObj implements API.IBanana {
    ...
    get jungle_japes(): number {
        return this.emulator.rdramReadS16(this.jungle_japes_addr);
    }
    set jungle_japes(value: number) {
        this.emulator.rdramWrite16(this.jungle_japes_addr, value);
    }
    ...
    get angry_aztec(): number {
        return this.emulator.rdramReadS16(this.angry_aztec_addr);
    }
    set angry_aztec(value: number) {
        this.emulator.rdramWrite16(this.angry_aztec_addr, value);
    }
    ...
    get frantic_factory(): number {
        return this.emulator.rdramReadS16(this.frantic_factory_addr);
    }
    set frantic_factory(value: number) {
        this.emulator.rdramWrite16(this.frantic_factory_addr, value);
    }
    ...
    get gloomy_galleon(): number {
        return this.emulator.rdramReadS16(this.gloomy_galleon_addr);
    }
    set gloomy_galleon(value: number) {
        this.emulator.rdramWrite16(this.gloomy_galleon_addr, value);
    }
    ...
    get fungi_forest(): number {
        return this.emulator.rdramReadS16(this.fungi_forest_addr);
    }
    set fungi_forest(value: number) {
        this.emulator.rdramWrite16(this.fungi_forest_addr, value);
    }
    ...
    get crystal_caves(): number {
        return this.emulator.rdramReadS16(this.crystal_caves_addr);
    }
    set crystal_caves(value: number) {
        this.emulator.rdramWrite16(this.crystal_caves_addr, value);
    }
    ...
    get creepy_castle(): number {
        return this.emulator.rdramReadS16(this.creepy_castle_addr);
    }
    set creepy_castle(value: number) {
        this.emulator.rdramWrite16(this.creepy_castle_addr, value);
    }
    ...
    get dk_isles(): number {
        return this.emulator.rdramReadS16(this.dk_isles_addr);
    }
    set dk_isles(value: number) {
        this.emulator.rdramWrite16(this.dk_isles_addr, value);
    }
    ...
    get hideout_helm(): number {
        return this.emulator.rdramReadS16(this.hideout_helm_addr);
    }
    set hideout_helm(value: number) {
        this.emulator.rdramWrite16(this.hideout_helm_addr, value);
    }
    ...
    get unknown_1(): number {
        return this.emulator.rdramReadS16(this.unknown_1_addr);
    }
    set unknown_1(value: number) {
        this.emulator.rdramWrite16(this.unknown_1_addr, value);
    }
    ...
    get unknown_2(): number {
        return this.emulator.rdramReadS16(this.unknown_2_addr);
    }
    set unknown_2(value: number) {
        this.emulator.rdramWrite16(this.unknown_2_addr, value);
    }
    ...
    get unknown_3(): number {
        return this.emulator.rdramReadS16(this.unknown_3_addr);
    }
    set unknown_3(value: number) {
        this.emulator.rdramWrite16(this.unknown_3_addr, value);
    }
    ...
    get unknown_4(): number {
        return this.emulator.rdramReadS16(this.unknown_4_addr);
    }
    set unknown_4(value: number) {
        this.emulator.rdramWrite16(this.unknown_4_addr, value);
    }
    ...
    get null(): number {
        return this.emulator.rdramReadS16(this.null_addr);
    }
    set null(value: number) {
        this.emulator.rdramWrite16(this.null_addr, value);
    }
...
export class Player extends API.BaseObj implements API.IPlayer {
    ...
    tns_totals: API.IBanana;

    constructor(emu: IMemory) {
        super(emu);

        this.tns_totals = new TnSTotals(emu);
...
export class Runtime extends API.BaseObj implements API.IRuntime {
    ...
    get current_profile(): API.ProfileType { return this.emulator.rdramRead8(this.cur_profile_addr) as API.ProfileType; }
    set current_profile(value: API.ProfileType) { this.emulator.rdramWrite8(this.cur_profile_addr, value); }
    get game_mode(): number { return this.emulator.rdramRead8(this.game_mode_addr); }
    set game_mode(value: number) { this.emulator.rdramWrite8(this.cur_profile_addr, value); }
...
export class SaveContext extends API.BaseObj implements API.ISaveContext {
    ...
    constructor(emu: IMemory) {
        ...
        this.temp_flags = new TempFlags(emu);
    }
    ...
    get_slot(addr: number): Buffer { return this.emulator.rdramReadBuffer(addr, 0x13c); }
